...
public class CardGenerationEntry extends CardGenerationEntry_Base {
    ...
    public static Boolean hasCardGenerationEntryMatchingLine(final Person person, final String line) {
    ...
    public static Boolean hasCardGenerationEntryLine(final Person person, final String line) {
        for (final CardGenerationEntry cardGenerationEntry : person.getCardGenerationEntriesSet()) {
    ...
    public int getNumberOfCGRsAfterThisCGEAndBeforeTheNextCGE() {
        ...
        if (getPerson() != null) {
            Collection<CardGenerationEntry> cardGenerationEntries = getPerson().getCardGenerationEntriesSet();
            ...
            for (CardGenerationRegister cardGenerationRegister : getPerson().getCardGenerationRegisterSet()) {
    ...
    public static String createResearcherLine(final Employee employee) {
        ...
        final GiafProfessionalData giafProfessionalData =
                personProfessionalData.getGiafProfessionalDataByCategoryType(CategoryType.RESEARCHER);
        if (giafProfessionalData == null) {
            return null;
        }
        final Space campus = giafProfessionalData.getCampus();
    ...
    public static String createGrantOwnerLine(final Employee employee) {
        ...
        final PersonProfessionalData personProfessionalData = person.getPersonProfessionalData();
        final GiafProfessionalData giafProfessionalData =
                personProfessionalData.getGiafProfessionalDataByCategoryType(CategoryType.GRANT_OWNER);
        if (giafProfessionalData == null) {
            return null;
        }
        final Space campus = giafProfessionalData.getCampus();
